...
module.exports = (app) => {
  ...
  app
    .route("/api/accounting-lists")
    .get(catchError(accountingList.listAllAccountingLists));
  app
    .route("/api/accounting-lists/related/:id")
    .get(catchError(accountingList.getAccountingListByRelatedHeader));
};
